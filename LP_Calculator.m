...
% Last Modified by GUIDE v2.5 01-Nov-2019 01:39:59
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    constraints = get(handles.edit1,'String');
    constraints_before = cellstr(get(handles.listbox2,'String'));
    if length(constraints_before) == 0
        set(handles.listbox2,'String',constraints)
    else
        final = [constraints;constraints_before];
        set(handles.listbox2,'string',final)
    end
...
% handles    structure with handles and user data (see GUIDATA)
    %final = {};
    constraints = get(handles.edit5,'String');
    constraints_before = cellstr(get(handles.listbox2,'String'));
    if length(constraints_before) == 0
        set(handles.listbox2,'String',constraints)
    else
...
%calculation of Optimization
    ...
    inequalities = cellstr(get(handles.listbox2,'String')) % all constraints
    list = size(inequalities);
    column_num = list(1)-1; %get the number of constraints°üº¬optimization
    optimiation = coesolver(inequalities,column_num)

    set(handles.listbox3,'string',optimiation);
